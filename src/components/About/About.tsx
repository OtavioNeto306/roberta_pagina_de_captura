...
export const About: React.FC<AboutProps> = ({ className = '' }) => {
  ...
  return (
    <section id="sobre" className={`section-padding bg-gray-50 ${className}`}>
      <div className="container-max">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="relative">
            ...
            <div className="absolute -top-6 -right-6 w-full h-full bg-primary-200 rounded-2xl -z-10"></div>
            ...
            <div className="absolute -bottom-8 -left-8 bg-white rounded-xl shadow-xl p-6 max-w-xs">
              <div className="flex items-center mb-3">
                ...
                <div>
                  <div className="font-bold text-gray-900">Certificada</div>
                  <div className="text-sm text-gray-600">CRM Ativo</div>
                </div>
              </div>
